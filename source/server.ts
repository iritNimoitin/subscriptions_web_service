...
import movieRout from "./routes/movie";
import subscriptionRaut from "./routes/subscriptions";
...
router.use("/api/movies", movieRout);
router.use("/api/subscriptions", subscriptionRaut);
/** Error handling */
router.use((req, res, next) => {
